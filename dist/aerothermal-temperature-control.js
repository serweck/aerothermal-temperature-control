...
<defs>
              <linearGradient id=${m} x1="0" y1="0" x2="1" y2="1">
                ${this.modeState===bt?F`<stop offset="0%" stop-color="#5cc6ff" /><stop
                        offset="100%"
                        stop-color="#1f7fd6"
                      />`:F`<stop offset="0%" stop-color="#ffb454" /><stop
                        offset="100%"
                        stop-color="#e8730a"
                      />`}
              </linearGradient>
            </defs>
            <path class="track" d=${Pt(100,100,80,Tt,510)} />
            ${this.isOff?G:F`
          ...
          <div class="dial-center">
            ...
            <div class="target">
              ${this.isOff?W`<span class="int">--</span>`:W`<span class="int">${y}</span
                    ><span class="frac"
    ...
    `}_renderPresets(t){const e=this.config.presets??St;return W`
      <div class="presets">
        ${e.map(e=>W`
            <button
            ...
            >
              ${e.icon?W`<ha-icon icon=${e.icon}></ha-icon>`:G}
              <span>${e.label}</span>
            </button>
          `)}
      </div>
    `}_renderModes(){const t=this.config.show_modes??["off","cool","heat"];return W`
      <div class="modes">
        ${t.map(t=>{const e=Ct[t];if(!e)return G;const s=this.modeState===e.option;return W`
            <button
              class="mode ${s?"active":""}"
              title=${e.label}
  ...
  `,t([mt({attribute:!1})],Ot.prototype,"hass",void 0),t([ft()],Ot.prototype,"config",void 0),t([ft()],Ot.prototype,"_dragging",void 0),t([ft()],Ot.prototype,"_dragTemp",void 0),Ot=t([dt(wt)],Ot);export{Ot as AerothermalCard};
