...
<defs>
              <linearGradient id=${u} x1="0" y1="0" x2="1" y2="1">
                ${this.modeState===gt?W`<stop offset="0%" stop-color="#5cc6ff" /><stop
                        offset="100%"
                        stop-color="#1f7fd6"
            ...
            <path class="track" d=${Pt(100,100,80,Mt,Ot)} />
            ${this.isOff?V:W`
                  <!-- glow difuminado detras del aro -->
                  <path
                    class="glow"
                    style="stroke:${d}"
                    d=${Pt(100,100,80,l,Ot)}
                  />
                  <path
                    class="value"
                    style="stroke:url(#${u})"
          ...
          <div class="dial-center">
            <div class="preset-name">${v}</div>
            <div class="target">
              ${this.isOff?q`<span class="int">--</span>`:q`<span class="int">${g}</span
                    ><span class="frac"
                      ><span class="unit">°C</span
                      ><span class="dec">,${$}</span></span
                    >`}
            </div>
            ${null!=r?q`<div class="current">
    ...
    `}_renderPresets(t){const e=this.config.presets??Et;return q`
      <div class="presets">
        ${e.map(e=>q`
            <button
            ...
            >
              ${e.icon?q`<ha-icon icon=${e.icon}></ha-icon>`:V}
              <span>${e.label}</span>
            </button>
          `)}
      </div>
    `}_renderModes(){const t=this.config.show_modes??["off","cool","heat"];return q`
      <div class="modes">
        ${t.map(t=>{const e=St[t];if(!e)return V;const s=this.modeState===e.option;return q`
            <button
              class="mode ${s?"active":""}"
              title=${e.label}
  ...
  `,t([mt({attribute:!1})],kt.prototype,"hass",void 0),t([ft()],kt.prototype,"config",void 0),t([ft()],kt.prototype,"_dragging",void 0),t([ft()],kt.prototype,"_dragTemp",void 0),kt=t([dt(vt)],kt);export{kt as AerothermalCard};
