...
<defs>
            ...
            <path class="track" d=${Pt(100,100,Ot,Tt,510)} />
            ${this.isOff?G:W`
          ...
          <div class="dial-center">
            ...
            <div class="target">
              ${this.isOff?F`<span class="int">--</span>`:F`<span class="int">${y}</span
                    ><span class="frac"
    ...
    `}_renderPresets(t){const e=this.hass.states[this.activeThermostatId]?.attributes.preset_modes;if(!e)return G;const s=(this.config.presets??St).filter(t=>e.includes(t.preset));return s.length?F`
      <div class="presets">
        ${s.map(e=>F`
            <button
    ...
    `:G}_renderModes(){const t=this.config.show_modes??["off","cool","heat"];return F`
      <div class="modes">
