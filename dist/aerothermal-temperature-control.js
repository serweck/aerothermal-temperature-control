...
<defs>
              <linearGradient id=${p} x1="0" y1="0" x2="1" y2="1">
                ${this.modeState===ft?F`<stop offset="0%" stop-color="#5cc6ff" /><stop
                        offset="100%"
                        stop-color="#1f7fd6"
            ...
            <path class="track" d=${St(100,100,80,Ct,Pt)} />
            ${this.isOff?W:F`
                  <!-- glow difuminado detras del aro -->
                  <path
                    class="glow"
                    style="stroke:${d}"
                    d=${St(100,100,80,l,Pt)}
                  />
                  <path
                    class="value"
                    style="stroke:url(#${p})"
          ...
          <div class="dial-center">
            ...
            <div class="target">
              ${this.isOff?F`<span class="int">--</span>`:F`<span class="int">${_}</span
                    ><span class="frac"
    ...
    `}_renderPresets(t){const e=this.config.presets??xt;return F`
      <div class="presets">
        ${e.map(e=>F`
            <button
    ...
    `}_renderModes(){const t=this.config.show_modes??["off","cool","heat"];return F`
      <div class="modes">
        ${t.map(t=>{const e=At[t];if(!e)return W;const s=this.modeState===e.option;return F`
            <button
              class="mode ${s?"active":""}"
              title=${e.label}
  ...
  `,t([pt({attribute:!1})],Ot.prototype,"hass",void 0),t([ut()],Ot.prototype,"config",void 0),t([ut()],Ot.prototype,"_dragging",void 0),t([ut()],Ot.prototype,"_dragTemp",void 0),Ot=t([lt(gt)],Ot);export{Ot as AerothermalCard};
